...
public class ServiceRegistrationSnapshotFile {

    private static final Logger LOG = LoggerFactory.getLogger(ServiceRegistrationSnapshotFile.class);

    private String              path;

    public ServiceRegistrationSnapshotFile(String path) {
        super();
        this.path = path;
    }
